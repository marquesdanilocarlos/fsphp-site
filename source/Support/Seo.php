...
class Seo
{
    ...
    {
        return $this->getOptimizer()->data()->$name;
    }
    ...
    {
        return $this->getOptimizer()->optimize($title, $description, $url, $image, $follow)->render();
    }
    ...
    {
        return $this->getOptimizer()->data($title, $desc, $url, $image);
    }
}